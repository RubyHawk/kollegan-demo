...
export default function MajaContact() {
  ...
  const [isMajaSpeaking, setIsMajaSpeaking] = useState(false);
      ...
      vapiRef.current.on('call-start', () => {
        ...
        setMessages((prev) => [
          ...prev,
          {
            ...
            role: 'maja',
            text: 'Välkommen till Grand Hotel Kollegan, det är Maja i receptionen. Hur kan jag hjälpa dig idag?',
            timestamp: new Date(),
          },
        ]);
      });
        ...
        if (msg.type === 'transcript') {
          ...
          if (transcript.transcriptType === 'final') {
            setMessages((prev) => [
              ...
              {
                id: crypto.randomUUID(),
                role: transcript.role === 'assistant' ? 'maja' : 'user',
          ...
          <div className="bg-navy-900 border border-navy-700 rounded-2xl shadow-2xl shadow-black/40 overflow-hidden flex flex-col" style={{ maxHeight: 'calc(100vh - 48px)' }}>
            ...
            <div className="bg-gradient-to-r from-navy-800 to-navy-900 border-b border-navy-700 px-5 py-4 flex items-center gap-3 shrink-0">
              ...
              <div className="flex-1 min-w-0">
                <h3 className="text-cream-100 font-heading font-semibold text-sm">Maja</h3>
            ...
            {mode === 'call' && callStatus === 'connecting' && (
              <div className="px-5 py-8 border-b border-navy-700 flex flex-col items-center gap-3 bg-navy-800/50">
                ...
                <span className="text-xs text-cream-400 mt-2">Ansluter till Maja...</span>
              </div>
            )}
            ...
            {mode === 'idle' && (
              <div className="px-5 py-6 space-y-4">
                <div className="text-center">
                  ...
                  <h3 className="font-heading text-lg font-bold text-cream-100">Hej, jag är Maja!</h3>
