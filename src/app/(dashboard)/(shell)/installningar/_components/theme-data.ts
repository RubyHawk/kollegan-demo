...
export const THEMES: ThemeDef[] = [
  {
    id: 'soleria',
    label: 'Soleria',
    desc: 'Skandinavisk sol',
    swatches: ['#C48010', '#E09828', '#F5C84A', '#dce2ec', '#fafbfc'],
    light: {
      '--page-bg':        '#fafbfc',
      '--surface':        '#ffffff',
      '--surface-alt':    '#f0f3f7',
      ...
      '--accent':         '#C48010',
      '--accent-light':   '#E09828',
      '--accent-subtle':  'oklch(0.60 0.14 72 / 0.08)',
      '--accent-border':  'oklch(0.60 0.14 72 / 0.22)',
    },
    dark: {
      '--page-bg':        '#0d1018',
      '--surface':        '#141b28',
      ...
      '--accent':         '#E09828',
      '--accent-light':   '#F5C048',
      '--accent-subtle':  'oklch(0.70 0.15 75 / 0.1)',
      '--accent-border':  'oklch(0.70 0.15 75 / 0.22)',
    },
  },
  {
    id: 'claude',
