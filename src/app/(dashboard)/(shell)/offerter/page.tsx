...
function buildBlockingAlert(issues: BlockingErrorPayload[]): BlockingAlert {
...
function GenericErrorBanner({ message, onDismiss, compact = false }: { message: string; onDismiss: () => void; compact?: boolean }) {
  return (
    <div className={cn(
