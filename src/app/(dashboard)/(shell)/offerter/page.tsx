...
import { OffersPaginationFooter } from './_components/offers-pagination-footer';
import {
  BlockingAlertCard,
  GenericErrorBanner,
  buildBlockingAlert,
...
import { STATUS_LABEL, STATUS_STYLES, STATUS_TABS } from './_lib/offers-dashboard-constants';
import {
  canRemind,
  fmtDate,
  fmtOfferNumber,
