...
| 2026-04-25 | ISMS operations packet                                      | PR #614 / `pending`                                        | Added a lightweight operating-rhythm doc plus release, quarterly, and annual execution packets so the remaining stage-2 work can be run in larger, practical batches without inventing evidence or building more governance machinery                                                | Engineering lead |
