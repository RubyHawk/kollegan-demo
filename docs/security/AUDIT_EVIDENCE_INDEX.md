...
| 2026-04-24 | Security evidence merge gate                                | PR #564 / `52aa95b`                                        | Pull-request CI now fails security-relevant workflow, migration, auth, feature-flag, and public-offer/signing changes unless the PR also updates repo-backed security/evidence docs                                                             | Engineering lead |
