...
| Asset inventory and information handling | Included | The ERP handles production business data and security evidence that must be inventoried, classified, labelled, and transferred through controlled paths. | ISMS Manager | `docs/security/ASSET_INVENTORY.md`, `docs/security/INFORMATION_HANDLING_STANDARD.md`, `docs/security/INFORMATION_TRANSFER_STANDARD.md` |
| People, employment, and remote working | Included | Access-bearing contributors and administrators need onboarding, confidentiality, offboarding, and remote-working baselines even when personnel records remain outside the repo. | ISMS Manager | `docs/security/PEOPLE_AND_EMPLOYMENT_SECURITY_STANDARD.md`, `docs/security/REMOTE_WORKING_STANDARD.md` |
| Physical and hosting security | Included | Physical and environmental protections are largely inherited from hosting and workplace controls, but they still need explicit baseline ownership and review. | ISMS Manager | `docs/security/PHYSICAL_AND_HOSTING_SECURITY_STANDARD.md`, `docs/security/SUPPLIER_MANAGEMENT.md` |
