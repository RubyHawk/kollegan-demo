...
| Tracked files scanned | 1093 |
| Source files scanned | 884 |
| API route files | 128 |
...
| API v1 migration and wrappers | Open | Inventory shows 91 `/api/v1` route files, 25 feature API clients, and 1 legacy compatibility wrappers. |
