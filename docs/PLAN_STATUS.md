...
| Tracked files scanned | 1044 |
| Source files scanned | 838 |
| API route files | 120 |
| API v1 route files | 83 |
...
| API v1 migration and wrappers | Open | Inventory shows 83 `/api/v1` route files, 24 feature API clients, and 1 legacy compatibility wrappers. |
