...
| --- | --- | ---: | --- |
| Engineering / refactor structure | Open | 0% | All 18 implementation-order items are structurally covered in the repo; inventory shows 1 legacy wrappers, 0 files above 1000 lines, 9 files above 500 lines, and 14 dead-candidate rows. |
...
| Tracked files scanned | 1315 |
| Source files scanned | 1068 |
| API route files | 160 |
| API v1 route files | 123 |
| Feature API clients | 31 |
| Legacy API compatibility wrappers | 1 |
| Files above 1000 lines | 0 |
| Files above 500 lines | 9 |
...
| API v1 migration and wrappers | Open | Inventory shows 123 `/api/v1` route files, 31 feature API clients, and 1 legacy compatibility wrappers. |
| Cleanup and file-size enforcement | Open | Inventory shows 0 files above 1000 lines, 9 files above 500 lines, and 14 dead-candidate review rows. |
