...
| Tracked files scanned | 1051 |
| Source files scanned | 844 |
| API route files | 122 |
...
| API v1 migration and wrappers | Open | Inventory shows 85 `/api/v1` route files, 24 feature API clients, and 1 legacy compatibility wrappers. |
