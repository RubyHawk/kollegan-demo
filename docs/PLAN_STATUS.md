...
| Tracked files scanned | 1031 |
| Source files scanned | 825 |
| API route files | 120 |
...
| API v1 migration and wrappers | Open | Inventory shows 83 `/api/v1` route files, 23 feature API clients, and 1 legacy compatibility wrappers. |
