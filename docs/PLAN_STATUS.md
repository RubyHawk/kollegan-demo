...
| --- | --- | ---: | --- |
| Engineering / refactor structure | Open | 0% | All 18 implementation-order items are structurally covered in the repo; inventory shows 1 legacy wrappers, 0 files above 1000 lines, 6 files above 500 lines, and 14 dead-candidate rows. |
...
| Cleanup and file-size enforcement | Open | Inventory shows 0 files above 1000 lines, 6 files above 500 lines, and 14 dead-candidate review rows. |
