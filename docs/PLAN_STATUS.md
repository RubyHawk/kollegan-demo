...
| Tracked files scanned | 1357 |
| Source files scanned | 1106 |
| API route files | 165 |
| API v1 route files | 128 |
...
| API v1 migration and wrappers | Open | Inventory shows 128 `/api/v1` route files, 32 feature API clients, and 1 legacy compatibility wrappers. |
