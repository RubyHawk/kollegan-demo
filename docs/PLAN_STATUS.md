...
| --- | --- | ---: | --- |
| Engineering / refactor structure | Open | 0% | All 18 implementation-order items are structurally covered in the repo; inventory shows 1 legacy wrappers, 0 files above 1000 lines, 9 files above 500 lines, and 15 dead-candidate rows. |
...
| Tracked files scanned | 1350 |
| Source files scanned | 1100 |
| API route files | 165 |
...
| Cleanup and file-size enforcement | Open | Inventory shows 0 files above 1000 lines, 9 files above 500 lines, and 15 dead-candidate review rows. |
