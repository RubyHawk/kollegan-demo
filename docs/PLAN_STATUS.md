...
| --- | --- | ---: | --- |
| Engineering / refactor structure | Open | 0% | All 18 implementation-order items are structurally covered in the repo; inventory shows 0 legacy wrappers, 0 files above 1000 lines, 12 files above 500 lines, and 9 dead-candidate rows. |
...
| Cleanup and file-size enforcement | Open | Inventory shows 0 files above 1000 lines, 12 files above 500 lines, and 9 dead-candidate review rows. |
