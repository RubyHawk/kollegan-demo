...
| Tracked files scanned | 1055 |
| Source files scanned | 848 |
| API route files | 122 |
| API v1 route files | 85 |
| Feature API clients | 25 |
...
| API v1 migration and wrappers | Open | Inventory shows 85 `/api/v1` route files, 25 feature API clients, and 1 legacy compatibility wrappers. |
